...
# ╔═╡ 4d16e450-df79-45bc-8142-38bea4d11025
md"## Initial conditions"

# ╔═╡ a5f0af73-ee38-48bf-9308-7b53a595607b
begin
	u₀ = [0.001,0]
	tspan = (0.0,0.1)
end
...
@bind γ Slider(0:.01:1)

# ╔═╡ e1441518-06bf-4c1e-8796-dec47cf76974
@bind ζ Slider(0:.01:1)
...
plot(sol,linewidth=2,title ="Single-mode clarinet", xaxis = "Time", yaxis = "Solution", idxs=[1], label = ["p"], xlim=(0.05,0.06))
...
begin
	...
	p = u[:,1]
	#flow = (1 .+ p .- γ) .* sqrt.(abs.(γ.-p)) .* sign.(γ.-p)
	plot(u[:,1],u[:,2])
	vline!([γ])
end
...
# ╔═╡ 3c5b0b62-a9f7-4b7d-84b5-d49dae23b7ff
begin
	a=1
	b=2
	c=Complex(a,b)
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "7748c41227081115b155e413cd20b7875009958a"
